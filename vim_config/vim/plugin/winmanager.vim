...
function! <SID>StartWindowsManager()
	...
	if !gotvisible
		...
		wincmd H
		"wincmd L "make the explorers windows stay on the right
...
function! <SID>ToggleWindowsManager()
   ...
   "exe 'wincmd W'   "if win show on
   "exe 'wincmd h'   "the right, then add this 
   "if win show on the left ,just 'q'
   exe 'q'          
 end
endfunction
...
if g:AutoOpenWinManager
   " if !IsWinManagerVisible() "且winmanager没有打开
